<!-- Modal -->
<div class="modal fade" id="ComputerModal" role="dialog"></div>
<!-- /.modal -->

<!-- Modal -->
<div class="modal fade" id="archiveComputerModal" role="dialog">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content modal-danger">
        ...
        <div class="modal-footer">
          ...
          <input type="submit" name="archiveComputer" class="btn btn-outline" value="Yes">
        </div>
      </div> 
      <!-- /.modal-content -->
    </div>

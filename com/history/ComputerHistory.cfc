component displayname = "ComputerHistory" output = "false" hint = "Computer History class" accessors = "true" extends="itmanagement/com/history/History"
{
	...
	function createHistory(History) {
		try {
			...
			sqlQuery.setSQL("
				...
				(id_itmanagement, date, time, remarks, attachment)
				VALUES
				(:id_itmanagement, :date, :time, :remarks, :attachment)
			");
			...
			sqlQuery.addParam(name="attachment", value=arguments.History.Attachment, CFSQLTYPE="CF_SQL_LONGVARCHAR");
